...
The bonus exercise connected the [DA MCP server](https://markus-haack.com/da-mcp/) to Cursor. Once set up, attendees could read, update, and create event pages in DA through plain-language chat — no browser, no form, no app.
...
- [DA MCP](https://markus-haack.com/da-mcp/) — the MCP server featured in Exercise 5
