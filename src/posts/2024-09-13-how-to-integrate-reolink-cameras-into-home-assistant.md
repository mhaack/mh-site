...
{% image "/assets/images/reolink-setup-1.png", "Set up a Reolink camera in Home Assistant", "x-small", "Set up a Reolink camera in Home Assistant" %}
...
{% image "/assets/images/reolink-setup-2.png", "Reolink camera integration in Home Assistant", "small", "Reolink camera integration in Home Assistant" %}
...
{% image "/assets/images/reolink-setup-3.jpeg", "Camera detail view in Home Assistant", "small", "Camera detail view in Home Assistant" %}
...
{% image "/assets/images/reolink-setup-4.png", "Add camera entity to your Lovelace dashboard", "small", "Add camera entity to your Lovelace dashboard" %}
