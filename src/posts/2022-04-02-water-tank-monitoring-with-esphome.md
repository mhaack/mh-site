...
tags:
 ...
 - smarthome
images:
 feature: /assets/images/watertank-unsplash.jpg
 height: h-96
description: Watering our lawn and plants around the house wasn't one of my
...
![schematic drawing cistern](/assets/images/cistern.jpg 'Schematic drawing of our cistern with pump and sensor placement'){class="small"}
...
![microcontroller watertank sensor](/assets/images/microcontroller-watertank.jpg 'Photo of Wemo D1 microcontroller'){class="x-small"}
...
![fritzing diagram of water tank sensor setup](/assets/images/watertank_steckplatine.png 'Wiring  diagram of water tank sensor setup'){class="x-small"}
...
![Compare ESPHome sensor & flow meter](/assets/images/bildschirmfoto-2022-06-02-um-11.32.png 'Compare watering sensor data with flow meter'){class="small"}
...
![Screenshot ESPHome integration](/assets/images/screenshot_esphome_integration.png 'Screenshot of ESPHome sensor in Home Assistant'){class="small"}
