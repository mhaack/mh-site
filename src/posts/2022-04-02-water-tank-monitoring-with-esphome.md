...
{% image "/assets/images/cistern.jpg", "schematic drawing cistern", "small", "Schematic drawing of our cistern with pump and sensor placement" %}
...
{% image "/assets/images/microcontroller-watertank.jpg", "microcontroller watertank sensor", "x-small", "Photo of Wemo D1 microcontroller" %}
...
{% image "/assets/images/watertank_steckplatine.png", "fritzing diagram of water tank sensor setup", "x-small", "Wiring  diagram of water tank sensor setup" %}
...
{% image "/assets/images/bildschirmfoto-2022-06-02-um-11.32.png", "Compare ESPHome sensor & flow meter", "small", "Compare watering sensor data with flow meter" %}
...
{% image "/assets/images/screenshot_esphome_integration.png", "Screenshot ESPHome integration", "small", "Screenshot of ESPHome sensor in Home Assistant" %}
